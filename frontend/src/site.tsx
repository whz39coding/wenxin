...
export const heroHighlights = [
  {
    title: '识文析字',
    description: '智能 OCR 文本重构：精准识别古籍字形与版面，确保每一篇传世经典都能被准确还原与阅读。',
  },
  {
    title: '寻章问义',
    description: '使用 “上下文感知”语义切片技术，将古籍切分为携带上下文的“智识单元”使 RAG 检索查得更准，让每一次解惑都回归典籍原文的韵味',
  },
  {
    title: '竹简观书',
    description: '重构竹简排布结构与阅读顺序，让尘封典籍在光影之间重生，为阅读提供原始的历史质感与智慧体验。',
  },
];
